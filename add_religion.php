...
if(isset($_GET['id']))
{	
	if ($_SESSION['stype'] == 'Staff' && !in_array('Update', $religion_per)) {
...
{
if ($_SESSION['stype'] == 'Staff' && !in_array('Write', $religion_per)) {
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Religion_Management']; ?></h3>
                </div>
                ...
                <div class="card">
					 ...
					 <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
										...
										<div class="form-group mb-3">
                                            <label><?php echo $lang['Religion_Title']; ?></label>
										...
										<input type="hidden" name="id" value="<?php echo $_GET['id'];?>"/>
										 ...
										 <div class="form-group mb-3">
                                            <label><?php echo $lang['Religion_Status']; ?></label>
                                    ...
                                    <div class="card-footer text-left">
                                        <button  type="submit" class="btn btn-primary"><?php echo $lang['Edit_Religion']; ?></button>
                                    </div>
                                </form>
					 <?php 
				 }
				 ...
				 ?>
                  <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer text-left">
                                        <button  type="submit" class="btn btn-primary"><?php echo $lang['Add_Religion']; ?></button>
                                    </div>
                                </form>
				 <?php } ?>
                </div>
