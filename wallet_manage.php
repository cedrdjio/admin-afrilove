...
if ($_SESSION['stype'] == 'Staff' && !in_array('Update', $wallet_per)) {
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Wallet_Management']; ?></h3>
                </div>
          ...
          <div class="container-fluid dashboard-default">
           ...
           <div class="col-sm-12">
                  ...
                  <?php 
					 ...
					 ?>
					 <div class="mng_btn">
					 <p class="btn btn-info"><?php echo $lang['Wallet_Balance:']; ?> <?php echo $data['wallet'].$set['currency'];?></p>
					 </div>
                  <div class="card-body">
                      ...
                      <div class="tab-pane fade active show" id="pills-warninghome" role="tabpanel" aria-labelledby="pills-warninghome-tab">
                       <form method="POST"  enctype="multipart/form-data" style="margin-top: 32px;">
								...
								<div class="form-group mb-3">
                                        ...
                                        <label  id="basic-addon1"><?php echo $lang['Enter_Amount']; ?></label>
                                    
                                  <input type="number" step="0.01" class="form-control" placeholder="<?php echo $lang['Enter_Amount']; ?>" name="amount" required>
								  <input type="hidden" name="type" value="add_wallet_balance"/>
										<input type="hidden" name="id" value="<?php echo $_GET['id'];?>"/>
                               
								</div>
								
								
                                    <button type="submit" class="btn btn-primary"> <i class="fa-solid fa-wallet"></i> <?php echo $lang['Add_Wallet_Balance']; ?> </button>
                      ...
                      <div class="tab-pane fade" id="pills-warningprofile" role="tabpanel" aria-labelledby="pills-warningprofile-tab">
                        <form method="POST"  enctype="multipart/form-data" style="margin-top: 32px;">
								...
								<div class="form-group mb-3">
                                  ...
                                  <input type="number" step="0.01" class="form-control" placeholder="<?php echo $lang['Enter_Amount']; ?>" name="amount" required>
								  <input type="hidden" name="type" value="sub_wallet_balance"/>
										<input type="hidden" name="id" value="<?php echo $_GET['id'];?>"/>
                               
								</div>
								
								
                                    <button type="submit" class="btn btn-danger"><i class="fa-solid fa-wallet"></i> <?php echo $lang['Substract_Wallet_Balance']; ?> </button>
		 ...
		 <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Wallet_Log']; ?></h3>
                </div>
		  ...
		  <div class="container-fluid dashboard-default">
           ...
           <div class="col-sm-12">
                ...
                <table class="display" id="basic-1">
                        ...
                        <tbody>
                           <?php 
										$city = $dating->query("select * from wallet_report where uid=".$_GET["id"]."");
										$i=0;
