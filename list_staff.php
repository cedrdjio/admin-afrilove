        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Staff_List_Management']; ?></h3>
                </div>
                        ...
                        <thead>
                          <tr>
											...
											<th><?php echo $lang['Password']; ?></th>
												<th><?php echo $lang['Staff_Status']; ?></th>
												<th><?php echo $lang['Action']; ?></th>
									</tr>
                                        </thead>
                                        <tbody>
                                           <?php 
										$city = $dating->query("select * from tbl_manager");
										$i=0;
										while($row = $city->fetch_assoc())
										{
										   ...
										   <a href="add_staff.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
