...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $gift_per)) {
      ...
      <div class="page-body-wrapper">
       ...
       <?php require 'inc/Sidebar.php';?>
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Gift_List_Management']; ?></h3>
                </div>
                        ...
                        <thead>
                          <tr>
                            <th><?php echo $lang['Sr_No.']; ?></th>
											...
											<th><?php echo $lang['Gift_Image']; ?></th>
											<th><?php echo $lang['Gift_Coin']; ?></th>
												<th><?php echo $lang['Gift_Status']; ?></th>
												<?php 
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $gift_per)) {
			?>
		...
		else 
		{
                        ...
                        <tbody>
                           <?php 
										$city = $dating->query("select * from tbl_gift");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $interest_per)) {
				?>
                                                <td style="white-space: nowrap; width: 15%;"><div class="tabledit-toolbar btn-toolbar" style="text-align: left;">
                                           <div class="btn-group btn-group-sm" style="float: none;">
										   <a href="add_gift.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
