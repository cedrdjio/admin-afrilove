...
if(isset($_GET['id']))
{	
	if ($_SESSION['stype'] == 'Staff' && !in_array('Update', $rgoal_per)) {
...
{
if ($_SESSION['stype'] == 'Staff' && !in_array('Write', $rgoal_per)) {
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Relation_Goal_Management']; ?></h3>
                </div>
                ...
                <div class="card">
					 ...
					 <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-body">
										...
										<div class="form-group mb-3">
                                            <label><?php echo $lang['Relation_Goal_Title']; ?></label>
										...
										<div class="form-group mb-3">
                                            <label><?php echo $lang['Relation_Goal_Subtitle']; ?></label>
										 ...
										 <div class="form-group mb-3">
                                            <label><?php echo $lang['Relation_Goal_Status']; ?></label>
                                    ...
                                    <div class="card-footer text-left">
                                        <button  type="submit" class="btn btn-primary"><?php echo $lang['Edit_Relation_Goal']; ?></button>
                                    </div>
                                </form>
					 <?php 
				 }
				 ...
				 ?>
                  <form method="post" enctype="multipart/form-data">
                                    ...
                                    <div class="card-footer text-left">
                                        <button  type="submit" class="btn btn-primary"><?php echo $lang['Add_Relation_Goal']; ?></button>
                                    </div>
                                </form>
				 <?php } ?>
                </div>
