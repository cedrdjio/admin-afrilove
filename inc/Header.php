...
?>
<!DOCTYPE html>
<html lang="en" <?php if (isset($currentLang) && $currentLang == 'ar') echo 'dir="rtl"'; ?>>
<head>
    <meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
   
    <link rel="icon" href="assets/images/afrilove-icon.png" type="image/png">
    <link rel="shortcut icon" href="assets/images/afrilove-icon.png" type="image/png">
    <title>AfriLove World — Admin</title><link rel="preconnect" href="https://fonts.googleapis.com/">
