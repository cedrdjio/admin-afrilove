	...
	$i = $i + 1;
		...
		else 
		{
			...
			<?php } ?>
                                                ...
                                                <td><span    class=" badge badge-success"><?php echo $lang['Subscribe']; ?></span></td>
												<?php } else { ?>
												
												<td>
												<span class="badge   badge-danger"><?php echo $lang['Not_Subscribe']; ?></span></td>
												<?php } ?>
...
<td><?php if($row['is_verify'] == 1){?><span  data-id="<?php echo $row['id'];?>" data-status="2" data-type="update_status" coll-type="verifystatus" class="drop badge badge-success"><?php echo $lang['Approve']; ?></span>
<span  data-id="<?php echo $row['id'];?>" data-status="0" data-type="update_status" coll-type="verifystatus" class="drop badge badge-danger"><?php echo $lang['Reject']; ?></span> <?php } else if($row['is_verify'] == 2) {echo 'Approved';}else {echo 'Wait For Upload';}?></td>
