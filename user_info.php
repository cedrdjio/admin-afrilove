    ...
    <?php require 'inc/Navbar.php';?>
      ...
      <div class="page-body-wrapper">
       ...
       <?php require 'inc/Sidebar.php';?>
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['User_Info_Management']; ?></h3>
                </div>
                        ...
                        <div class="row">
                          <div class="col-xl-12">
                            <div class="card">
                              <div class="card-header">
                                <h5 class="p-0">
                                  <button class="btn btn-link ps-0" ><?php echo $lang['My_Profile']; ?></button>
                                </h5>
                              </div>
						  ...
						  <div class="col-xl-12">
                            <div class="card">
                              <div class="card-header">
                                <h5 class="p-0">
                                  <button class="btn btn-link ps-0" ><?php echo $lang['Location']; ?></button>
                                </h5>
                              </div>
                              <div id="map"></div>
                            </div>
		...
		{
			if (in_array('Update', $wallet_per)) {
			?>
			  <a href="wallet_manage.php?id=<?php echo $_GET['user_id'];?>"><button class="btn btn-primary"><?php echo $lang['Wallet_Operation']; ?></button></a>
			<?php } if (in_array('Update', $coin_per)) { ?>
			  <a href="coin_manage.php?id=<?php echo $_GET['user_id'];?>"> <button class="btn btn-warning"><?php echo $lang['Coin_Operation']; ?></button></a>
			<?php 
			}
		}
		else 
		...
		<?php } ?>
                          ...
                          <div class="card">
                            ...
                            <div class="card-header pb-0">
                              <h5><?php echo $lang['Other_Picture']; ?></h5>
                            </div>
                        ...
                        <div class="col-sm-12">
                          <div class="card">
                            <div class="card-header social-header">
                              <h5 class="f-w-600"><?php echo $lang['Other_Information']; ?></h5>
                            </div>
                            <div class="card-body pt-0">
                              <div class="row details-about">
                                <div class="col-sm-6">
                                  <div class="your-details">
                                    <h6 class="f-w-600"><?php echo $lang['Profile_Bio']; ?>:</h6>
                                    <p class="mb-0"><?php echo $userinfo['profile_bio'];?></p>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="your-details your-details-xs">
                                    <h6 class="f-w-600"><?php echo $lang['Birth_Date']; ?>:</h6>
                                    <p class="mb-0"><?php 
...
$formatted_date = date('jS M Y', $timestamp);
                              ...
                              <div class="row details-about">
                                <div class="col-sm-6">
                                  <div class="your-details">
                                    <h6 class="f-w-600"><?php echo $lang['Search_Preference']; ?>:</h6>
                                    <p class="mb-0"><?php echo $userinfo['search_preference'];?></p>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="your-details your-details-xs">
                                    <h6 class="f-w-600"><?php echo $lang['Relation_Goal']; ?>:</h6>
                              ...
                              <div class="row details-about">
                                <div class="col-sm-6">
                                  <div class="your-details">
                                    <h6 class="f-w-600"><?php echo $lang['Gender']; ?>:</h6>
                                    <p class="mb-0"><?php echo $userinfo['gender'];?></p>
                                  </div>
                                </div>
                                <div class="col-sm-6">
                                  <div class="your-details your-details-xs">
                                    <h6 class="f-w-600"><?php echo $lang['Religion']; ?>:</h6>
							...
							<div class="row details-about">
								<div class="col-sm-6">
                                  <div class="your-details your-details-xs">
                                    <h6 class="f-w-600"><?php echo $lang['Radius_Search']; ?>:</h6>
								...
								<div class="col-sm-6">
                                  <div class="your-details your-details-xs">
                                    <h6 class="f-w-600"><?php echo $lang['Wallet_Balance']; ?>:</h6>
...
<div class="col-sm-12">
                          <div class="card">
                            <div class="card-header social-header">
                              <h5 class="f-w-600"><?php echo $lang['Plan_Information']; ?> <span class="badge badge-primary"><?php echo $pinfo['title'].' Membership';?></span></h5>
                            </div>
                            <div class="card-body pt-0">
                              ...
                              <div class="row details-about">
                                <div class="col-sm-6">
                                  <div class="your-details">
                                    <h6 class="f-w-600"><?php echo $lang['Plan_Start_Date']; ?>:</h6>
                                    <p class="mb-0"><?php
...
$formatted_date = date('jS M Y', $timestamp);
                                ...
                                <div class="col-sm-6">
                                  <div class="your-details your-details-xs">
                                    <h6 class="f-w-600"><?php echo $lang['Plan_End_Date']; ?>:</h6>
                                    <p class="mb-0"><?php
...
<?php } ?>
						...
						<div class="col-sm-12">
                          <div class="card">
                            <div class="card-header pb-0">
                              <h5><?php echo $lang['Languages_Known']; ?></h5>
                            </div>
                            <div class="card-body p-xl-4">
                              <div class="avatar-showcase">
                                <div class="pepole-knows">
