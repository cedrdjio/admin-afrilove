...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $report_per)) {
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Report_List_Management']; ?></h3>
                </div>
                        ...
                        <thead>
                          <tr>
                            <th><?php echo $lang['Sr_No.']; ?></th>
												...
												<th><?php echo $lang['Report_maker_user']; ?></th>
												<th><?php echo $lang['Report_gain_user']; ?></th>
