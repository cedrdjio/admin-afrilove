...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $interest_per)) {
      ...
      <div class="page-body-wrapper">
       ...
       <?php require 'inc/Sidebar.php';?>
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Interest_List_Management']; ?></h3>
                </div>
                        ...
                        <thead>
                          <tr>
                            <th><?php echo $lang['Sr_No.']; ?></th>
											...
											<th><?php echo $lang['Interest_Image']; ?></th>
											<th><?php echo $lang['Interest_Title']; ?></th>
		...
		else 
		{
                        ...
                        <tbody>
                           <?php 
										$city = $dating->query("select * from tbl_interest");
										$i=0;
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $interest_per)) {
				?>
										   ...
										   <a href="add_interest.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
