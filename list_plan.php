...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $plan_per)) {
      ...
      <div class="page-body-wrapper">
       ...
       <?php require 'inc/Sidebar.php';?>
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                  <h3><?php echo $lang['Plan_List_Management']; ?></h3>
                </div>
                        ...
                        <thead>
                          <tr>
                            <th><?php echo $lang['Sr_No.']; ?></th>
											...
											<th><?php echo $lang['Plan_Title']; ?></th>
											<th><?php echo $lang['Plan_Amount']; ?></th>
											<th><?php echo $lang['Day_Limit']; ?></th>
											<th><?php echo $lang['Filter_Include_?']; ?> </th>
											<th><?php echo $lang['Direct_Chat_?']; ?> </th>
											<th> <?php echo $lang['Chat_?']; ?> </th>
											<th> <?php echo $lang['Like_Menu_?']; ?> </th>
											<th> <?php echo $lang['Audio_Video_?']; ?> </th>
												<th><?php echo $lang['Plan_Status']; ?></th>
												<?php 
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $plan_per)) {
			?>
		...
		else 
		{
                        ...
                        <tbody>
                           <?php 
										$city = $dating->query("select * from tbl_plan");
										$i=0;
										while($row = $city->fetch_assoc())
										{
											...
											<tr>
												...
												<td>
                                                    <?php echo $row['day_limit'].' Days'; ?>
                                                </td>
												
												<td>
                                                    <?php echo ($row['filter_include'] == 1) ? 'Yes': 'No' ; ?>
                                                </td>
												
												<td>
                                                    <?php echo ($row['direct_chat'] == 1) ? 'Yes': 'No' ; ?>
                                                </td>
												
												<td>
                                                    <?php echo ($row['chat'] == 1) ? 'Yes': 'No' ; ?>
                                                </td>
												
												<td>
                                                    <?php echo ($row['Like_menu'] == 1) ? 'Yes': 'No' ; ?>
                                                </td>
                                                
												<td>
                                                    <?php echo ($row['audio_video'] == 1) ? 'Yes': 'No' ; ?>
                                                </td>
                                               
												<?php if($row['status'] == 1) { ?>
												
                                                <td><span class="badge badge-primary"><?php echo $lang['Publish']; ?></span></td>
												<?php } else { ?>
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $plan_per)) {
				?>
										   ...
										   <a href="add_plan.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
