...
if ($_POST['name'] == '') {
    $returnArr = array("ResponseCode"=>"401","Result"=>"false","ResponseMsg"=>"Empty Name!"); 
} elseif ($_POST['email'] == '') {
    $returnArr = array("ResponseCode"=>"401","Result"=>"false","ResponseMsg"=>"Empty Email!"); 
} elseif ($_POST['mobile'] == '') {
     $returnArr = array("ResponseCode"=>"401","Result"=>"false","ResponseMsg"=>"Empty Mobile!"); 
} elseif ($_POST['password'] == '') {
    $returnArr = array("ResponseCode"=>"401","Result"=>"false","ResponseMsg"=>"Empty Password!"); 
} elseif ($_POST['ccode'] == '') {
     $returnArr = array("ResponseCode"=>"401","Result"=>"false","ResponseMsg"=>"Empty Ccode!"); 
} 
else
{
