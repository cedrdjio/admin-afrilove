...
$returnArr = array("ResponseCode"=>"200","Result"=>"true","ResponseMsg"=>"Home Data Get Successfully!!!","profilelist"=>$user,"currency"=>$set['currency'],"totalliked"=>$likes,"direct_chat"=>$direct_chat,"Like_menu"=>$Like_menu,"audio_video"=>$audio_video,"filter_include"=>$filter_include,"plan_name"=>$plan_name,"plan_id"=>$plan_id,"plan_description"=>$plan_description,'is_subscribe'=>$is_subscribe,'plandata'=>$plan,'chat'=>$chat,'is_verify'=>$getplan['is_verify'],"coin"=>$getdata["coin"]);	
}
