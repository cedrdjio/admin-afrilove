...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $package_per)) {
      ...
      <div class="page-body-wrapper">
       ...
       <?php require 'inc/Sidebar.php';?>
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
											...
											<th><?php echo $lang['Total_Coin']; ?></th>
											<th><?php echo $lang['Amount']; ?></th>
												<th><?php echo $lang['Package_Status']; ?></th>
												<?php 
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $package_per)) {
			?>
		...
		else 
		{
                                        ...
                                        <tbody>
                                           <?php 
										$city = $dating->query("select * from tbl_package");
										$i=0;
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $package_per)) {
				?>
										   ...
										   <a href="add_package.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
