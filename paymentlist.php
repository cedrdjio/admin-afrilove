...
if ($_SESSION['stype'] == 'Staff' && !in_array('Read', $plist_per)) {
      ...
      <div class="page-body-wrapper">
       ...
       <?php require 'inc/Sidebar.php';?>
        ...
        <div class="page-body">
          <div class="container-fluid">
            <div class="page-title">
              <div class="row">
                <div class="col-sm-6">
                 <h3><?php echo $lang['Payment_Gateway_List_Management']; ?></h3>
                </div>
                ...
                <table class="display" id="basic-1">
                        <thead>
                          <tr>
                                               ...
                                               <th><?php echo $lang['Payment_Gateway_Name']; ?></th>
												<th><?php echo $lang['Payment_Gateway_Subtitle']; ?></th>
                                                <th><?php echo $lang['Payment_Gateway_Image']; ?></th>
                                                
                                                
                                                <th><?php echo $lang['Payment_Gateway_Status']; ?></th>
												 <th><?php echo $lang['Show_On_Wallet?']; ?></th>
                                                <?php 
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $plist_per)) {
			?>
		...
		else 
		{
                                        ...
                                        <tbody>
                                           <?php 
											 $stmt = $dating->query("SELECT * FROM `tbl_payment_list` where id NOT IN(5,11)");
$i = 0;
												...
												if($_SESSION['stype'] == 'Staff')
		{
			if (in_array('Update', $plist_per)) {
				?>
										   ...
										   <a href="edit_payment.php?id=<?php echo $row['id'];?>" class="tabledit-edit-button" style="float: none; margin: 5px;"><svg width="25" height="25" viewBox="0 0 25 25" fill="none" xmlns="http://www.w3.org/2000/svg">
